...
export function Footer() {
  return (
    <div className="bg-green-900 py-12 mt-15">
      <div className="text-beige-100 grid grid-cols-1 items-center max-w-2xs m-auto md:max-w-2xl md:grid-cols-2">

        <div className="flex flex-col items-center justify-center pb-3 mb-3 border-r-0 border-b md:pb-0 md:mb-0 md:border-b-0 md:border-r">
