        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="">
            ...
            <ul className="flex flex-col text-sm gap-3 text-gray-800 lg:text-md">
              ...
              <li><a className="flex gap-2 items-center hover:text-green-900" href="https://wa.me/558191313343?text=Olá,%20vim%20pelo%20site" target="_blank" rel="noopener noreferrer"><Phone className="text-beige-100" /> +55 81 9131 3343</a></li>
